...
var file_game_engine_proto_rawDesc = []byte{
	...
	,
...
var file_game_engine_proto_depIdxs = []int32{
	0, // 0: m.gameengine.v1.Game.GetSize:input_type -> m.gameengine.v1.GetSizeRequest
	2, // 1: m.gameengine.v1.Game.SetScore:input_type -> m.gameengine.v1.SetScoreRequest
	1, // 2: m.gameengine.v1.Game.GetSize:output_type -> m.gameengine.v1.GetSizeResponse
	3, // 3: m.gameengine.v1.Game.SetScore:output_type -> m.gameengine.v1.SetScoreResponse
...
func (c *gameClient) GetSize(ctx context.Context, in *GetSizeRequest, opts ...grpc.CallOption) (*GetSizeResponse, error) {
	out := new(GetSizeResponse)
	err := c.cc.Invoke(ctx, "/m.gameengine.v1.Game/GetSize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameClient) SetScore(ctx context.Context, in *SetScoreRequest, opts ...grpc.CallOption) (*SetScoreResponse, error) {
	out := new(SetScoreResponse)
	err := c.cc.Invoke(ctx, "/m.gameengine.v1.Game/SetScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGameServer) GetSize(context.Context, *GetSizeRequest) (*GetSizeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSize not implemented")
}
func (*UnimplementedGameServer) SetScore(context.Context, *SetScoreRequest) (*SetScoreResponse, error) {
...
func _Game_GetSize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSizeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GameServer).GetSize(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m.gameengine.v1.Game/GetSize",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServer).GetSize(ctx, req.(*GetSizeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Game_SetScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetScoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GameServer).SetScore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/m.gameengine.v1.Game/SetScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServer).SetScore(ctx, req.(*SetScoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Game_serviceDesc = grpc.ServiceDesc{
	ServiceName: "m.gameengine.v1.Game",
	HandlerType: (*GameServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSize",
			Handler:    _Game_GetSize_Handler,
		},
		{
			MethodName: "SetScore",
			Handler:    _Game_SetScore_Handler,
		},
	},
